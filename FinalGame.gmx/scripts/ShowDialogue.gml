...
ds_list_add(g_dlg, "g %3What the hell just happened?")
...
ds_list_add(g_dlg, "l %3Eh. We were shipmates once, on the...@%2 the S.S. Alliman. About 5 years ago.")
...
ds_list_add(g_dlg, "l %3Son of a... %all right. Check the map, try to figure out where we're going.")
...
ds_list_add(g_dlg, "Barmaid You know, it's funny, you asking about him. Just another day, there was another couple in here, looking for him. Looked a mite bit fiercer than you two.")
ds_list_add(g_dlg, "l Another couple?")
ds_list_add(g_dlg, "Barmaid Yeah. Seafarers, of course. A man and woman. Yes, they were asking some very pertinent questions about Priest. Where he was, how long he'd been here... And they only missed him by one day.")
...
ds_list_add(g_dlg, "Barmaid Priest used to mention a man named Baxter sometimes. They were shipmates together back in the day. But Priest has reformed and all that.")
...
ds_list_add(g_dlg, "Tavern-master And there's a bit of %3time pressure %involved, yes?")
...
ds_list_add(g_dlg, "lu Last week, a young pair of pirates -- probably brother and sister, or maybe a dysfunctional relationship -- raided a ship outside of Brax and picked up some information on a treasure buried by a pirate called Maury Baxter.")
